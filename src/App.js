...
const App = () => {
  ...
  const handleCategoryClick = (category) => {
    const filtered = products.filter((product) => product.company === category);
  ...
  return (
    <div className="App">
      ...
      <div className="categories">
        ...
        <button onClick={() => handleCategoryClick('ikea')}>Ikea</button>
        <button onClick={() => handleCategoryClick('marcos')}>Marcos</button>
        <button onClick={() => handleCategoryClick('caressa')}>Caressa</button>
        <button onClick={() => handleCategoryClick('liddy')}>Liddy</button>
      </div>
